...
export const githubConfig = {
  repoUrl: 'https://github.com/REPLACE_ME/JunAI', // TODO: confirm public repo URL
  repoName: 'JunAI',
  description:
...
export const releaseConfig = {
  version: '[VERSION]',
  apkSizeMb: '[SIZE]',
  minAndroidVersion: '[MINIMUM_ANDROID_VERSION]',
  releaseDate: '[RELEASE_DATE]',
  apkDownloadUrl: '', // TODO: link to GitHub Releases asset once published
  githubReleaseUrl: 'https://github.com/REPLACE_ME/JunAI/releases/latest',
