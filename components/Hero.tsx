      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-16 px-5 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <div className="mt-9 flex flex-col gap-3.5 sm:flex-row">
            <Link
              href="/download"
              className="btn-tactile border-glow-signal group flex items-center justify-center gap-2 rounded-lg bg-signal-500 px-6 py-3.5 font-display text-sm tracking-wide text-white hover:bg-signal-600"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="btn-tactile flex items-center justify-center gap-2 rounded-lg border border-hairline px-6 py-3.5 font-display text-sm tracking-wide text-chrome-100 hover:border-chrome-500/60"
            >
              <GithubIcon />
              View on GitHub
            </a>
