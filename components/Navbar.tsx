      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="btn-tactile flex items-center gap-2 rounded-full border border-hairline px-4 py-2 text-sm text-chrome-100 transition-colors hover:border-signal-500/50 hover:text-signal-400"
          >
            <GithubIcon />
            GitHub
          </a>
        ...
        <button
          className="btn-tactile flex h-10 w-10 items-center justify-center text-chrome-100 md:hidden"
          onClick={() => setOpen((v) => !v)}
          aria-expanded={open}
        ...
        <div className="min-h-0">
          <nav className="glass-panel flex flex-col gap-1 border-t border-hairline px-5 pb-6 pt-2">
            ...
            <a
              ...
              rel="noreferrer"
              onClick={() => setOpen(false)}
              className="btn-tactile mt-2 flex items-center gap-2 rounded-lg border border-hairline px-3 py-3 text-base text-chrome-100"
            >
              <GithubIcon />
              View on GitHub
            </a>
