...
export function AndroidBotIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#3DDC84" width={64} height={64} {...props}>
      <path d="M17.6 9.48l1.84-3.18a.4.4 0 0 0-.7-.4l-1.86 3.22a10.9 10.9 0 0 0-8.76 0L6.26 5.9a.4.4 0 1 0-.7.4l1.84 3.18C4.8 11.09 3 13.9 3 17.1h18c0-3.2-1.8-6.01-3.4-7.62ZM8.5 14.5a1.1 1.1 0 1 1 0-2.2 1.1 1.1 0 0 1 0 2.2Zm7 0a1.1 1.1 0 1 1 0-2.2 1.1 1.1 0 0 1 0 2.2Z" />
      <path d="M3.5 18v3.4a1.4 1.4 0 0 0 2.8 0V18h-2.8Z" />
      <path d="M17.7 18v3.4a1.4 1.4 0 0 0 2.8 0V18h-2.8Z" />
      <path d="M7 18v4.6a1.4 1.4 0 0 0 2.8 0V19.8h.4v2.8a1.4 1.4 0 0 0 2.8 0V19.8h.4v2.8a1.4 1.4 0 0 0 2.8 0V18H7Z" />
    </svg>
  );
}
...
export function TagIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M12.6 3.4H6.8a1.4 1.4 0 0 0-1.4 1.4v5.8c0 .37.15.73.41 1l8.4 8.4a1.4 1.4 0 0 0 2 0l5.8-5.8a1.4 1.4 0 0 0 0-2l-8.4-8.4a1.4 1.4 0 0 0-1-.41Z" />
...
export function FileIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M7 3.5h7l4 4v13a1.2 1.2 0 0 1-1.2 1.2H7A1.2 1.2 0 0 1 5.8 20.5v-16A1.2 1.2 0 0 1 7 3.5Z" />
      <path d="M14 3.5V8h4" />
    </svg>
  );
}
...
export function ShieldIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M12 3.5l7 2.6v5.4c0 4.6-3 8.1-7 9-4-.9-7-4.4-7-9V6.1l7-2.6Z" />
    </svg>
  );
}
...
export function ScrollViewIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <rect x="2.5" y="5" width="6.5" height="14" rx="1.4" />
      <rect x="9.6" y="6.5" width="5.4" height="11" rx="1.2" opacity="0.65" />
      <rect x="16" y="8" width="4" height="8" rx="1" opacity="0.35" />
    </svg>
  );
}
