        ...
        <Reveal>
          <div className="border-glow-signal glass-panel flex flex-col items-start gap-6 rounded-2xl p-8 sm:flex-row sm:items-center sm:justify-between sm:p-10">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex shrink-0 items-center gap-1.5 rounded-lg bg-chrome-100 px-5 py-3 font-display text-sm text-void transition-transform hover:-translate-y-0.5"
            >
              View repository
